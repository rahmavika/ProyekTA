...
<div class="d-flex justify-content-center align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h2 class="h3 text-center">Edit Data Supplier</h2>
</div>
        ...
        <div class="card-body">
            <form action="/dashboard-supplier/{{ $supplier->id }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    name="nama_supplier" id="nama_supplier" value="{{ old('nama_supplier', $supplier->nama_supplier) }}" placeholder="Nama Supplier">
                    @error('nama_supplier')
                ...
                <div class="mb-3">
                    ...
                    name="telepon" id="telepon" value="{{ old('telepon', $supplier->telepon) }}" placeholder="08xxxxxxxxxx">
                    @error('telepon')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    name="email" id="email" value="{{ old('email', $supplier->email) }}" placeholder="name@example.com">
                    @error('email')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
